package com.rakeshp.newsapp.data.manager
...
import com.rakeshp.newsapp.utill.Constants
import com.rakeshp.newsapp.utill.Constants.USER_SETTINGS
...
class LocalUserManagerImpl (
    ...
    override fun ReadAppEntry(): Flow<Boolean> {
        return context.dataStore.data.map{
            prefrences->prefrences[PreferencesKeys.APP_ENTRY]?:false
        }
    }
}
